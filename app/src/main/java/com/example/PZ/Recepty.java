...
public class Recepty extends AppCompatActivity {
    ...
    private RecyclerViewAdapterPatient adapter;
        ...
        call.enqueue(new Callback<ArrayList<LoginResult>>() {
            ...
            public void onResponse(Call<ArrayList<LoginResult>> call, Response<ArrayList<LoginResult>> response) {
                ...
                if (response.code() == 200) {
                    ...
                    {
                        exampleList.add(new DoktorSzukaj(tab.get(i).getImie() + " " + tab.get(i).getNazwisko(),
                                tab.get(i).getName()));
                    }
                    RecyclerView recyclerView = findViewById(R.id.recyclerv_view);
                    recyclerView.setHasFixedSize(true);
                    RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(Recepty.this);
                    adapter = new RecyclerViewAdapterPatient(Recepty.this,exampleList);
